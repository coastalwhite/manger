...
macro_rules! impl_consume_int {
    ( $type: ty ) => {
        impl $crate::Consumable for $type {
            fn consume_from(s: &str) -> Result<(Self, &str), ConsumeError> {
                let (Sign(is_positive), unconsumed) = Sign::consume_from(s)?;
...
//             }
//         );
//         assert_eq!(u8::consume_from("256").unwrap_err(), InvalidValue);
//     }
...
//             }
//         );
//         assert_eq!(u16::consume_from("65536").unwrap_err(), InvalidValue);
//     }
...
//             }
//         );
//         assert_eq!(u32::consume_from("4294967296").unwrap_err(), InvalidValue);
//     }
...
//             }
//         );
//         assert_eq!(i8::consume_from("128").unwrap_err(), InvalidValue);
//         assert_eq!(i8::consume_from("-129").unwrap_err(), InvalidValue);
//     }
...
//             }
//         );
//         assert_eq!(i16::consume_from("32768").unwrap_err(), InvalidValue);
//         assert_eq!(i16::consume_from("-32769").unwrap_err(), InvalidValue);
//     }
...
//             }
//         );
//         assert_eq!(i32::consume_from("2147483648").unwrap_err(), InvalidValue);
//         assert_eq!(i32::consume_from("-2147483649").unwrap_err(), InvalidValue);
//     }
